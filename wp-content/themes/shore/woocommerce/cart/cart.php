...
<table class="shop_table cart" cellspacing="0">
	<thead>
		<tr>
            ...
            <th class="product-thumbnail"><span><?php _e( 'Image', 'woocommerce' ); ?></span></th>		
	...
	<tbody>
		...
		<tr>
			<td colspan="6" class="actions">
                ...
                <input type="submit" class="checkout-button alt wc-forward proceed_button" name="proceed" value="<?php _e( 'Proceed to Checkout', 'woocommerce' ); ?>" />
