...
<?php if ( ! is_ajax() ) : ?><div id="order_review"><?php endif; ?>
	...
	<table class="shop_table">
		<thead>
			<tr>
				<th class="product-name"><span><?php _e( 'Your order', 'woocommerce' ); ?></span></th>
	...
	<div id="payment">
		...
		<div class="form-row place-order">
			...
			echo apply_filters( 'woocommerce_order_button_html', '<input type="submit" class=" alt" name="woocommerce_checkout_place_order" id="place_order" value="' . esc_attr( $order_button_text ) . '" data-value="' . esc_attr( $order_button_text ) . '" />' );
			?>
